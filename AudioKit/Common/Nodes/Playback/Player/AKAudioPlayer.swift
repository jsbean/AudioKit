...
open class AKAudioPlayer: AKNode, AKToggleable {
    ...
    fileprivate func initialize() {
        ...
        if internalAudioFile.length > 0 {
            ...
            let beforeScheduleBuffer = DispatchTime.now().uptimeNanoseconds / 1_000_000_000
            ...
            let afterScheduleBuffer = DispatchTime.now().uptimeNanoseconds / 1_000_000_000
            let timeTaken = afterScheduleBuffer - beforeScheduleBuffer
            print("time taken to schedule buffer: \(timeTaken)")
